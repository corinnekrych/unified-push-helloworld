...
//        UIApplication.sharedApplication().setStatusBarStyle(.LightContent, animated: false)
    ...
    func application(application: UIApplication, didRegisterForRemoteNotificationsWithDeviceToken deviceToken: NSData) {
        ...
        let url =  NSURL(string: "http://192.168.0.2:8080/ag-push/")
        println("URL:\(url)")
        let urlun = url!
        println("URL:\(urlun)")
        let registration = AGDeviceRegistration(serverURL: urlun)
        println("REGISTRATION::\(registration)")
        // perform registration of this device
        registration.registerWithClientInfo({ (clientInfo: AGClientDeviceInformation!) in
            println("REGISTRATION_WITH_CLIENT::\(clientInfo)")
            // set the deviceToken
            ...
            clientInfo.variantID = "e02c398d-78f0-4536-b66c-5b780da8128c"
            clientInfo.variantSecret = "ac7f957e-92fa-41bc-aaa6-3a9ca93ee03e"
