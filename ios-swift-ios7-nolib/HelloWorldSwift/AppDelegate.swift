...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didRegisterForRemoteNotificationsWithDeviceToken deviceToken: NSData) {
        ...
        let url =  NSURL(string: "https://ups-ckrych.rhcloud.com/ag-push/")
        let registration = AGDeviceRegistration(serverURL: url!)
        ...
        registration.registerWithClientInfo({ (clientInfo: AGClientDeviceInformation!) in
            ...
            clientInfo.variantID = "c378e1b2-7729-48bb-8f5b-bcd7e9287c4c"
            clientInfo.variantSecret = "4c8ff6d8-9e65-4e76-ad4c-2a8f7145184e"
